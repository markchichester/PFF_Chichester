#!/usr/bin/env python3
"""Export QB Alignment.xlsx to qb-alignment.csv for the QB profile app."""
import csv
import zipfile
...
XLSX = ROOT / "QB Alignment.xlsx"
OUT = ROOT / "qb-alignment.csv"
...
def main():
    ...
    if not rows:
        raise ValueError("QB Alignment.xlsx is empty.")
